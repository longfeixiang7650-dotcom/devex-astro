...
export const ALL_TOOLS: ToolData[] = [
  {
    ...
    firstHandNote:
      `VS Code's official site leads with “The open source AI code editor,” with “Your home for multi-agent development” right beneath it. The hero screenshot shows the editor running a multi-agent session — a REFACTOR MAILLIST COMPONENT panel beside a SESSIONS sidebar listing concurrent tasks. The top nav spans Features, Docs, Release Notes, Blog, Learn, Events, and Resources, and the one loud call-to-action is “Download for Windows.”`,
  ...
  },
{
  ...
  },
  {
    ...
    firstHandNote:
      `PyCharm's page opens on its “only … you need” headline (truncated in the screenshot) with a subtitle aimed at web, data, and AI/ML professionals. Small print reads “Free forever, plus one month of Pro included.” It's the standard JetBrains nav, with “Download” as the primary action.`,
...
},
{
  ...
  },
  {
    ...
    firstHandNote:
      `Hoppscotch is a web-based API request builder, and the screenshot shows the working app itself — a dark-mode workspace with a request tab open — rather than a marketing splash page. It's an open-source Postman alternative for sending HTTP requests and testing APIs directly in the browser.`,
